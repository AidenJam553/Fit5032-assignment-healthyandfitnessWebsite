...
import { registerLocal, getRedirectForEmail } from '@/lib/auth'
  ...
  <div class="auth">
    <div class="card">
      ...
      <form @submit.prevent="onSubmit" class="form">
        ...
        <p class="policy" :class="{ ok: passwordPolicyOk }">6+ chars, include a-z, A-Z, 0-9</p>
      ...
      <div id="googleBtnReg" style="margin-top:8px"></div>
